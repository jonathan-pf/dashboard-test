...
export function Skills() {
  const skills = useIdeasByType('Skill')
                ...
                {editingId === idea.id ? (
                  <div className="mt-2 space-y-2">
                    <textarea
                      ...
                      className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none resize-none"
                      rows={3}
                      autoFocus
                    />
                    <div className="flex gap-2 justify-end">
                      ...
                      <button
                        ...
                        disabled={updateIdea.isPending}
                        className="px-3 py-1 text-xs bg-pink-600 text-white rounded-md hover:bg-pink-700 disabled:opacity-50"
                      >
